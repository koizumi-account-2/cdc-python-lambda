from modules.models import Purpose, ColorSuggestionList, Judgement, State
from modules.prompts import purpose_prompt, suggestion_prompt, check_prompt
import json
...
class CheckSuggestion:
    ...
    def run(self, state: State) -> dict:
        ...
        print("CheckSuggestion完了",result)
        return {
